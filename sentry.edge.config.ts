...
// The config you add here will be used whenever middleware or edge routes handle a request.
...
if (!SENTRY_DSN) {
  if (process.env.NODE_ENV === 'development') {
    console.warn(
      '[Sentry] NEXT_PUBLIC_SENTRY_DSN is not set. Edge runtime error tracking is disabled.'
    )
  }
} else {
  Sentry.init({

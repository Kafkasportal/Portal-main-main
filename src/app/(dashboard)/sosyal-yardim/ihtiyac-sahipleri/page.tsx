...
export default function BeneficiariesPage() {
  ...
  const [filterIhtiyacDurumu, setFilterIhtiyacDurumu] = useState<string>('all')
  ...
  const { data, isLoading, isError, refetch } = useBeneficiaries({
    ...
    ihtiyacDurumu: filterIhtiyacDurumu !== 'all' ? filterIhtiyacDurumu : undefined,
          ...
          <Sheet open={isFilterOpen} onOpenChange={setIsFilterOpen}>
            ...
            <SheetContent side="right" className="w-100 sm:w-135">
              ...
              <div className="mt-6 space-y-6">
                ...
                {/* İhtiyaç Durumu Filtresi */}
                <div className="space-y-2">
                  <label className="text-sm font-medium">İhtiyaç Durumu</label>
                  <Select value={filterIhtiyacDurumu} onValueChange={setFilterIhtiyacDurumu}>
                    <SelectTrigger>
                      <SelectValue placeholder="Tüm İhtiyaç Durumları" />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="all">Tüm İhtiyaç Durumları</SelectItem>

  ...
  return (
    <header className="border-border bg-card/80 flex h-16 items-center justify-between border-b px-4 shadow-sm backdrop-blur-sm lg:px-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <Button
          variant="outline"
          className="text-muted-foreground bg-background border-border hover:bg-accent/50 hover:text-foreground hidden w-64 items-center justify-start gap-2 transition-all sm:flex"
          onClick={() => {
            setCommandOpen(true)
          }}
        >
          ...
          <kbd className="bg-muted text-muted-foreground text-2.5 pointer-events-none inline-flex h-5 items-center gap-1 rounded border px-1.5 font-mono font-medium select-none">
      ...
      <div className="flex items-center gap-2">
        ...
        >
          ...
          <span className="bg-destructive absolute top-1.5 right-1.5 h-2 w-2 animate-pulse rounded-full shadow-sm" />

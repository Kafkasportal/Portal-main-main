  ...
  if (hasChildren) {
    ...
    return (
      <div className="w-full">
        ...
        {isOpen && !isCollapsed && (
          <div className="border-sidebar-primary/30 animate-in slide-in-from-top-2 mt-1 ml-4 space-y-1 border-l-2 pl-4 duration-200">
  ...
  return (
    <TooltipProvider>
      ...
      >
        ...
        {/* Navigation */}
        <nav className="scrollbar-thin scrollbar-thumb-sidebar-border scrollbar-track-transparent flex-1 space-y-1 overflow-y-auto p-3">
          {NAV_ITEMS.map((item) => (
        ...
        <Tooltip delayDuration={0}>
          <TooltipTrigger asChild>
            <button
              ...
              className="from-sidebar-primary to-warning border-background absolute top-20 -right-3 flex h-7 w-7 items-center justify-center rounded-full border-2 bg-linear-to-br transition-all duration-200 hover:scale-110 hover:shadow-lg"
            >
              <ChevronRight
                className={cn(

...
describe('mappers', () => {
  describe('mapMember', () => {
    const dbMember = {
      ...
      aidat_durumu: 'odendi' as const,
      kan_grubu: 'A+' as const,
      meslek: 'Mühendis',
      meslegi: null,
    ...
    it('should convert aidat status correctly', () => {
      expect(
        mapMember({ ...dbMember, aidat_durumu: 'odendi' }).aidatDurumu
      ).toBe('guncel')
      expect(
        mapMember({ ...dbMember, aidat_durumu: 'gecikti' }).aidatDurumu
      ).toBe('gecmis')
      expect(
        mapMember({ ...dbMember, aidat_durumu: 'beklemede' }).aidatDurumu
      ).toBe('muaf')
    })
  ...
  describe('mapDonation', () => {
    const dbDonation = {
      ...
      amac: 'egitim',
      odeme_yontemi: 'kredi_karti' as const,
      bagisci_telefon: null,
      bagisci_email: null,
      bagisci_adres: null,
      makbuz_no: null,
      aciklama: null,
  ...
  describe('mapBeneficiary', () => {
    const dbBeneficiary = {
      ...
      durum: 'aktif' as const,
      ihtiyac_durumu: 'yuksek' as const,
      medeni_hal: 'evli',
      hane_buyuklugu: 4,
      meslek: 'Ev Hanımı',
      aylik_gelir: 2000,
      egitim_durumu: 'lise',
      relationship_type: 'İhtiyaç Sahibi Kişi' as const,
      parent_id: null,
      uyruk: null,
      yabanci_kimlik_no: null,
      fon_bolgesi: null,
      dosya_baglantisi: null,
      mernis_dogrulama: null,
      cep_telefonu: null,
      cep_telefonu_operator: null,
      sabit_telefon: null,
      yurtdisi_telefon: null,
      ulke: null,
      sehir: null,
      mahalle: null,
      baba_adi: null,
      anne_adi: null,
      belge_turu: null,
      belge_gecerlilik_tarihi: null,
      seri_numarasi: null,
      onceki_uyruk: null,
      onceki_isim: null,
      pasaport_turu: null,
      pasaport_numarasi: null,
      pasaport_gecerlilik_tarihi: null,
      vize_giris_turu: null,
      ...
      es_adi: null,
      es_telefon: null,
      ailedeki_kisi_sayisi: null,
      cocuk_sayisi: null,
      yetim_sayisi: null,
      calisan_sayisi: null,
      bakmakla_yukumlu_sayisi: null,
      sponsorluk_tipi: null,
      riza_beyani_durumu: null,
      notlar: null,
      created_at: '2023-01-01T00:00:00Z',
      updated_at: '2024-01-01T00:00:00Z',
    }
    ...
    it('should map economic status', () => {
      ...
      expect(result.ekonomikDurum?.meslek).toBe('Ev Hanımı')
      expect(result.ekonomikDurum?.aylikGelir).toBe(2000)
    })
    ...
    it('should map relationship type correctly', () => {
      ...
      const depResult = mapBeneficiary({
        ...dbBeneficiary,
        relationship_type: 'Bakmakla Yükümlü Olunan Kişi' as const,
      })
  ...
  describe('mapApplication', () => {
    const dbApplication = {
      ...
      basvuran_ad: 'Ali',
      basvuran_soyad: 'Veli',
      basvuran_tc_kimlik_no: '11111111111',
      basvuran_telefon: '05551111111',
      basvuran_adres: 'Test Adres',
      yardim_turu: 'nakdi' as const,
      talep_edilen_tutar: 2000,
      onaylanan_tutar: null,
      gerekce: 'Test gerekçe',
      durum: 'beklemede' as const,
      basvuru_tarihi: '2024-01-15',
      degerlendirme_tarihi: null,
      notlar: null,

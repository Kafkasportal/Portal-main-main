...
test.describe('Dashboard Testleri', () => {
  test.describe('Dashboard Görünümü', () => {
    test('dashboard sayfası doğru yüklenmeli', async ({
      ...
      await expect(
        page.getByText('Dernek istatistikleri ve son aktiviteler')
      ).toBeVisible()
    })

    test('tüm istatistik kartları görünmeli', async ({
      authenticatedPage: page,
    }) => {
      // İstatistik kartları
    ...
    test('istatistik değerleri görünmeli', async ({
      authenticatedPage: page,
    }) => {
    ...
    test('aylık bağış grafiği görünmeli', async ({
      authenticatedPage: page,
    }) => {
    ...
    test('yardım dağılımı grafiği görünmeli', async ({
      authenticatedPage: page,
    }) => {
    ...
    test('son bağışlar listesi görünmeli', async ({
      authenticatedPage: page,
    }) => {
      ...
      const donationItems = page
        .locator('[class*="donation-item"], [class*="list"] > div')
        .first()
  ...
  test.describe('Dashboard Navigasyonu', () => {
    test('grafik detaylarına gidilebilmeli', async ({
      authenticatedPage: page,
    }) => {
    ...
    test('son bağışlar tümünü gör linki çalışmalı', async ({
      authenticatedPage: page,
    }) => {
  ...
  test.describe('Sidebar Navigasyonu', () => {
    ...
    test('sidebar daraltılabilmeli', async ({ authenticatedPage: page }) => {
      ...
      await expect(
        page.getByRole('button', { name: /Genişlet/i })
      ).toBeVisible()
    })
  })
  ...
  test.describe('Header Testleri', () => {
    ...
    test('bildirimler butonu görünmeli', async ({
      authenticatedPage: page,
    }) => {
      await expect(
        page.getByRole('button', { name: 'Bildirimler' })
      ).toBeVisible()
    })

    test('kullanıcı menüsü görünmeli', async ({ authenticatedPage: page }) => {
      await expect(
        page.getByRole('button', { name: /Ahmet Yönetici/i })
      ).toBeVisible()
    })

    test('kullanıcı menüsü açılabilmeli', async ({
      authenticatedPage: page,
    }) => {
  ...
  test.describe('Dashboard Veri Kontrolü', () => {
    test('toplam bağış değeri pozitif olmalı', async ({
      authenticatedPage: page,
    }) => {
